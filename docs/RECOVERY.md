...
hashes for all required tables, indexes, and triggers. Restore verifies the source before creating
its nonexistent disposable destination; it never overwrites the active authority.
